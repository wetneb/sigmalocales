...
(** * Definition of the first-order Cantor locale
    We define the sigma-locale of opens of Cantor
    space, using the free construction.

    ** Preordered set of generators. *)
...
Section CantorLocale.
  ...
  (** We can now define the meet on the generators. *)
  ...
  Instance CantorGenMSL : MeetSemiLattice CantorGenle :=
    MkMSL
      CantorGen
      CantorGenle
      Cyl_Preorder
  ...
  (** * Properties of the Cantor frame *)
